...
namespace ult {
    ...
    /* ASAP Packages */
    extern std::string UPDATE_ASAP_1;
    extern std::string UPDATE_ASAP_2;
    extern std::string UPDATE_ASAP_3;
    extern std::string UPDATE_ASAP_4;
    // Sections
    ...
    extern std::string HOCCUSTOM;
    extern std::string ENABLED;
    extern std::string CLKCNG;
    extern std::string SCPLUS_INFO;
    extern std::string SC_STATUS;
    extern std::string DEFCLK;
    extern std::string LDR_TOOL;
    extern std::string LDR_INFO;
    extern std::string TOOL_WARNING_1;
    extern std::string TOOL_WARNING_2;
    extern std::string TOOL_WARNING_3;
    extern std::string TOOL_WARNING_4;
    extern std::string TOOL_WARNING_5;
    extern std::string CPU_VOLTAGE;
    extern std::string CPU_INFO;
    extern std::string CPU_CHART;
    extern std::string USED;
    extern std::string HOC_KIP;
    // Package-Extra Setting+
    extern std::string ES_DISABLED;
    extern std::string CD_LAUNCHER;
    extern std::string INSTALL_PATH;
    extern std::string INSTALL_VER;
    extern std::string RBOOT_OPTION;
    extern std::string CD_LAUNCHER_INFO;
    extern std::string AND_LCR_INFO;
    extern std::string UBU_LCR_INFO;
    extern std::string SET_OS_NAND;
    extern std::string REBOOT_BOOTLOADER;
    extern std::string USB_HS_INFO;
    extern std::string DDR_INFO;
    extern std::string UNSURE_INFO;
    extern std::string SET_UBU_VER;
    ...
    extern std::string NOTIFY_ENABLED;
    extern std::string NOTIFY_DISABLED;
    ...
    extern std::string AM_STR;
    extern std::string PM_STR;
    #endif
