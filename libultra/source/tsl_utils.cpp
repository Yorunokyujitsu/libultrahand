...
namespace ult {
    ...
    std::string TOOL_WARNING_3;
    std::string TOOL_WARNING_4;
    std::string TOOL_WARNING_5;
    ...
    std::string GAP_1;
    std::string GAP_2;
    std::string NOTIFY_ENABLED;
    std::string NOTIFY_DISABLED;
    ...
    static constexpr LangEntry LANG_TABLE[] = {
        ...
        {&HIDDEN_OVERLAYS,            "HIDDEN_OVERLAYS",            "숨긴 오버레이"},
        {&PACKAGES,                   "PACKAGES",                   "Package+"},
        {&PACKAGE,                    "PACKAGE",                    "패키지"},
        {&HIDDEN_PACKAGES,            "HIDDEN_PACKAGES",            "숨긴 패키지"},
        {&HIDDEN,                     "HIDDEN",                     "숨긴 항목"},
        ...
        {&SWITCH_2_STYLE,             "SWITCH_2_STYLE",             "Switch 2 스타일"},
        {&DYNAMIC_LOGO,               "DYNAMIC_LOGO",               "동적 로고"},
        {&DYNAMIC_TABLES,             "DYNAMIC_TABLES",             "동적 테이블"},
        ...
        {&IN_PACKAGE_TITLES,          "IN_PACKAGE_TITLES",          "패키지 내 제목"},
        ...
        {&NOTIFICATION_SETTINGS,      "NOTIFICATION_SETTINGS",      "알림 설정"},
        {&SILENCE_NOTIFICATIONS,      "SILENCE_NOTIFICATIONS",      "조용한 알림"},
        {&STARTUP_NOTIFICATION,       "STARTUP_NOTIFICATION",       "시작 알림"},
        {&MAX_SLOTS,                  "MAX_SLOTS",                  "최대 슬롯"},
        {&API_NOTIFICATIONS,          "API_NOTIFICATIONS",          "API 알림"},
        {&API_TOGGLE_HOTKEY,          "API_TOGGLE_HOTKEY",          "API 토글 핫키"},
        {&DISMISS_NOTIFICATION,       "DISMISS_NOTIFICATION",       "API 알림 닫기"},
        {&API_TOGGLE,                 "API_TOGGLE",                 "API 알림 토글"},
        {&CLICK,                      "CLICK",                      "클릭"},
        {&TAP,                        "TAP",                        "탭"},
        {&HOLD_FOR_4S,                "HOLD_FOR_4S",                "4초간 입력 유지"},
        ...
        // Package-System Clock+
        {&HOCCUSTOM,                  "HOCCUSTOM",                  "커스텀"},
        {&ENABLED,                    "ENABLED",                    "활성화"},
        {&CLKCNG,                     "CLKCNG",                     "전환 도구"},
        {&SCPLUS_INFO,                "SCPLUS_INFO",                "Sys-ClkOC Toolkitloader.kip 관리 도구"},
        {&SC_STATUS,                  "SC_STATUS",                  "앱의 사용 여부 선택"},
        {&DEFCLK,                     "DEFCLK",                     "기본 지원 범위의 안정된 클럭 값 사용"},
        {&LDR_TOOL,                   "LDR_TOOL",                   "Loader.kip 편집 도구"},
        {&LDR_INFO,                   "LDR_INFO",                   "선택시 자동 재부팅"},
        {&TOOL_WARNING_1,             "TOOL_WARNING_1",             "Horizon-OC는 loader.kip을 수동 조작하여"},
        {&TOOL_WARNING_2,             "TOOL_WARNING_2",             "안정 범위 밖의 클럭까지 조정할 수 있습니다"},
        {&TOOL_WARNING_3,             "TOOL_WARNING_3",             "낸드에 치명적인 손상을 초래할 수 있으므로"},
        {&TOOL_WARNING_4,             "TOOL_WARNING_4",             "시스낸드에서의 편집/사용을 피해주십시오"},
        {&TOOL_WARNING_5,             "TOOL_WARNING_5",             "선택시 활성화되며 자동으로 재부팅합니다"},
        {&CPU_VOLTAGE,                "CPU_VOLTAGE",                "CPU 전압 허용 범위"},
        {&CPU_INFO,                   "CPU_INFO",                   "단위: mV"},
        {&CPU_CHART,                  "CPU_CHART",                  "　 구분"},
        {&USED,                       "USED",                       "사용중"},
        {&HOC_KIP,                    "HOC_KIP",                    "loader.kip 활성화재부팅 필요"},
        // Package-Extra Setting+
        ...
        {&RAM_PATCH_WARN,             "RAM_PATCH_WARN",             "8GB 패치는 8GB RAM 설치 기기 전용입니다"},
        {&MEM_PATCH,                  "MEM_PATCH",                  "40MB Memory 패치"},
        {&RAM_PATCH,                  "RAM_PATCH",                  "8GB RAM 패치"},
        // Package-Quick Guide+
        ...
        {&OVERLAY_DOES_NOT_EXIST,     "OVERLAY_DOES_NOT_EXIST",     "오버레이를 찾을 수 없습니다!"},
        ...
        {&GAP_1,                      "GAP_1",                      "     "},
        {&GAP_2,                      "GAP_2",                      "  "},
        {&NOTIFY_ENABLED,             "NOTIFY_ENABLED",             "API 알림 켜짐"},
        {&NOTIFY_DISABLED,            "NOTIFY_DISABLED",            "API 알림 꺼짐"},
    ...
    void localizeTimeStr(char* timeStr) {
        static const struct { const char* key; std::string* val; } mappings[] = {
            ...
            {"April",     &APRIL},     {"May",       &JUNE},      {"June",      &JUNE},
    ...
    void applyLangReplacements(std::string& text, bool isValue) {
        if (isValue) {
            ...
            switch (text.length()) {
                ...
                case 9:  if (text == "Reboot To") { text = REBOOT_TO; } else if (text == "INI Entry") { text = INI_ENTRY; } break;
