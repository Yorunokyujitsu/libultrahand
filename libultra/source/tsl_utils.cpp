...
namespace ult {
    ...
    std::string FORCE_AMS110_SUPPORT = "버전 강제 지원";
    ...
    std::string STARTUP_NOTIFICATION = "시작 알림";
    std::string EXTERNAL_NOTIFICATIONS = "외부 알림";
    ...
    std::string ULTRAHAND_HAS_RESTARTED = "Ultrahand 재시작됨";
    ...
    std::string ES_DISABLED = "비활성화";
    std::string CD_LAUNCHER = "런처 생성/제거";
    std::string INSTALL_PATH = "설치 경로";
    std::string INSTALL_VER = "설치 버전";
    std::string RBOOT_OPTION = "재부팅 옵션";
    std::string CD_LAUNCHER_INFO = "L4T 런처의 세부 설정을 조정합니다";
    std::string AND_LCR_INFO = "Android 기본 값을 생성/제거";
    std::string UBU_LCR_INFO = "Ubuntu 기본 값을 생성/제거";
    std::string SET_OS_NAND = "OS가 설치된 낸드를 설정";
    std::string REBOOT_BOOTLOADER = "재부팅 부트로더를 선택";
    std::string USB_HS_INFO = "USB 3.0 지원 유무 설정";
    std::string DDR_INFO = "삼성 SD 카드인 경우에만 활성화";
    std::string UNSURE_INFO = "잘 모르는 경우 설정하지 마세요";
    std::string SET_UBU_VER = "설치한 Ubuntu 버전을 반드시 지정";
    ...
    void reinitializeLangVars() {
        ...
        LAUNCH_COMBOS = "실행 버튼";
        STARTUP_NOTIFICATION = "시작 알림";
        EXTERNAL_NOTIFICATIONS = "외부 알림";
        ...
        // Package-Extra Setting+
        ES_DISABLED = "비활성화";
        CD_LAUNCHER = "런처 생성/제거";
        INSTALL_PATH = "설치 경로";
        INSTALL_VER = "설치 버전";
        RBOOT_OPTION = "재부팅 옵션";
        CD_LAUNCHER_INFO = "L4T 런처의 세부 설정을 조정합니다";
        AND_LCR_INFO = "Android 기본 값을 생성/제거";
        UBU_LCR_INFO = "Ubuntu 기본 값을 생성/제거";
        SET_OS_NAND = "OS가 설치된 낸드를 설정";
        REBOOT_BOOTLOADER = "재부팅 부트로더를 선택";
        USB_HS_INFO = "USB 3.0 지원 유무 설정";
        DDR_INFO = "삼성 SD 카드인 경우에만 활성화";
        UNSURE_INFO = "잘 모르는 경우 설정하지 마세요";
        SET_UBU_VER = "설치한 Ubuntu 버전을 반드시 지정";
        ...
        ULTRAHAND_HAS_RESTARTED = "Ultrahand 재시작됨";
    ...
    void parseLanguage(const std::string& langFile) {
        ...
        std::unordered_map<std::string, std::string*> configMap = {
            ...
            {"USED", &USED},
            // Package-Extra Setting+
            {"ES_DISABLED", &ES_DISABLED},
            {"CD_LAUNCHER", &CD_LAUNCHER},
            {"INSTALL_PATH", &INSTALL_PATH},
            {"INSTALL_VER", &INSTALL_VER},
            {"RBOOT_OPTION", &RBOOT_OPTION},
            {"CD_LAUNCHER_INFO", &CD_LAUNCHER_INFO},
            {"AND_LCR_INFO", &AND_LCR_INFO},
            {"UBU_LCR_INFO", &UBU_LCR_INFO},
            {"SET_OS_NAND", &SET_OS_NAND},
            {"REBOOT_BOOTLOADER", &REBOOT_BOOTLOADER},
            {"USB_HS_INFO", &USB_HS_INFO},
            {"DDR_INFO", &DDR_INFO},
            {"UNSURE_INFO", &UNSURE_INFO},
            {"SET_UBU_VER", &SET_UBU_VER},
