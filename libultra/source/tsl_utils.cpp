...
namespace ult {
    ...
    std::string HB_MENU_INFO = "Sphaira 실행 버튼, DBI 버전 설정";
    ...
    std::string LATEST_DBI_LANG = "러시아어";
    std::string LATEST_DBI_INFO = "DBI를 최신 버전으로 변경합니다";
    std::string LATEST_DBI = "최신 DBI";
    ...
    void reinitializeLangVars() {
        ...
        HB_MENU = "홈브류 설정";
        HB_MENU_INFO = "Sphaira 실행 버튼, DBI 버전 설정";
        ...
        LATEST_DBI_LANG = "러시아어";
        LATEST_DBI_INFO = "DBI를 최신 버전으로 변경합니다";
        LATEST_DBI = "최신 DBI";
        SD_CLEANUP = "SD 카드 정리";
    ...
    void parseLanguage(const std::string& langFile) {
        ...
        static std::unordered_map<std::string, std::string*> configMap = {
            ...
            {"LATEST_DBI_LANG", &LATEST_DBI_LANG},
            {"LATEST_DBI_INFO", &LATEST_DBI_INFO},
            {"LATEST_DBI", &LATEST_DBI},
