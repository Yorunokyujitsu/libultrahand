...
namespace ult {
    ...
    const std::string INCLUDED_THEME_FOLDER_URL = "https://raw.githubusercontent.com/Yorunokyujitsu/ASAP-NX/dev/misc/ini/ultrahand/";
    const std::string INCLUDED_WALLPAPER_FOLDER_URL = "https://raw.githubusercontent.com/Yorunokyujitsu/ASAP-NX/dev/misc/res/ultrahand.rgba";
    const std::string LANGUAGE_FOLDER_URL = "https://raw.githubusercontent.com/Yorunokyujitsu/ASAP-NX/dev/misc/json/lang/ultrahand/";
    const std::string LATEST_RELEASE_INFO_URL = "https://raw.githubusercontent.com/Yorunokyujitsu/ASAP-NX/dev/version.inc";
