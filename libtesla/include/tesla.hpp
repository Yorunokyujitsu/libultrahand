...
namespace tsl {
    ...
    inline constexpr TempGradientRange DEFAULT_TEMP_RANGE_HIGH(45.0f, 57.0f, 68.0f, 80.0f);
    ...
    namespace gfx {
        ...
        public:
            ...
            void updateLayerSize() {
                ...
                // to work around a compositor ordering quirk.
                        ...
                        if (minusAlone) {
                            if (!minusHoldArmed) {
                                ...
                                if (ult::useNotifications) {
                                    ...
                                    if (tsl::notification)
                                        notification->show(ult::NOTIFY_HEADER+ult::NOTIFY_ENABLED, 22, 0);
                                } else {
                                    ult::deleteFileOrDirectory(ult::NOTIFICATIONS_FLAG_FILEPATH);
                                    if (tsl::notification)
                                        notification->show(ult::NOTIFY_HEADER+ult::NOTIFY_DISABLED, 22, 0);
                                }
                                shData->keysDown &= ~KEY_MINUS;
                                shData->keysHeld &= ~KEY_MINUS;
                            }
